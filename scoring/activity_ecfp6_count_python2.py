...
class activity_ecfp6_count_python2(object):
    """Scores based on an count ECFP6 classifier for activity. It loads files pickled with python2."""
    ...
    def __call__(self, smiles: List[str]) -> dict:
        ...
        fps = activity_ecfp6_count_python2.fingerprints_from_mols(valid_mols)
    ...
    def __reduce__(self):
        ...
        """
        return activity_ecfp6_count_python2, (self.clf_path,)
